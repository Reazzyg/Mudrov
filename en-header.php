...
<head>
  ...
  <title>
    <? echo isset($title) ?  $title . ' | ' :  "" ?> Mudrov - full cycle marketing agency
  </title>
</head>
  ...
  <header class="header layout__header" id="top">
    <div class="container header-container grid">
      ...
      <div class="header-menu menu">
        <ul class="menu-list">
          <li class="menu-list__item"><a href="/en/" class="menu-list__link">Cases</a></li>
          <li class="menu-list__item"><a href="/en/agency/" class="menu-list__link">Agency</a></li>
          <li class="menu-list__item"><a href="/en/services/" class="menu-list__link">Services</a></li>

          <li class="menu-list__item"><a href="/en/contacts/" class="menu-list__link">Contacts</a></li>
        </ul>
      </div>
      <!-- /. header-menu -->
      <div class="header-menu header-menu--mobile menu open">
        ...
        <div class="header-lang header-lang--mobile">
          ...
          <span data-lang="ru" class="header-lang__lang header-lang__lang--active">ru</span>
          <span data-lang="en" class="header-lang__lang">en</span>
